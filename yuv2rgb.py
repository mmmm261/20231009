...
if __name__ == '__main__':
    yuv_list = glob.glob(os.path.join(r"C:\Users\1\Desktop\tmp\tmp_20230608\crop_no_crop" + '\\*.yuv'))
    for yuv in yuv_list:
        ...
        with open(yuv, "rb") as yuv_f:
            ...
            for frame_idx in range(frames):
                ...
                if bgr_data is not None:
                    cv2.imwrite(yuv.replace('crop_no_crop', 'crop_no_crop_result').replace('yuv', 'png'), bgr_data)
                    frame_idx +=1
