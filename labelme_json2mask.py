...
def GetArgs():
    ...
    parser.add_argument('--input', '-i', default = r'C:\Users\1\Desktop\202207_202209_biaozhu\json', help='json文件目录')
    parser.add_argument('--out-mask', '-m',  default = r'C:\Users\1\Desktop\202207_202209_biaozhu\mask', help='mask图存储目录')
    parser.add_argument('--out-img', '-r', default = r'C:\Users\1\Desktop\202207_202209_biaozhu\mask_', help='json文件中提取出的原图存储目录' )
    parser.add_argument('--out-viz', '-v', default = r'C:\Users\1\Desktop\202207_202209_biaozhu\maskupimg',help='mask与原图合并viz图存储目录')
